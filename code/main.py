...
def run():
    ...
    prompt = """ I need a semi furnished flat with a budget of 40 lakhs to 60 lakhs in sector 104 gurgaon. I am a single professional but i want a large unit atleast 3bhk. I travel a lot so proximity to airport and main market in critical"""
